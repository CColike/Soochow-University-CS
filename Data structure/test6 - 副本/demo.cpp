...
int main()
{
    ...
    // cout<<"wrnm,nbbdwssb:"<<endl;
    // Tree t;
    // int a,b,c;
    // t.getdegree(a,b,c);
    // cout<<a<<' '<<b<<' '<<c<<endl;
    // a=t.getdepth();cout<<"depth:"<<a<<endl;
    // b=t.getwidth();cout<<"wodth:"<<b<<endl;
    // t.inorder();cout<<endl;
    ...
    // tt.getdegree(a,b,c);
    // cout<<a<<' '<<b<<' '<<c<<endl;
    // a=tt.getdepth();cout<<"depth:"<<a<<endl;
    // b=tt.getwidth();cout<<"wodth:"<<b<<endl;
    // tt.inorder();cout<<endl;
    // tt.postorder();cout<<endl;
    // tt.preorder();cout<<endl;
    // tt.levelorder();cout<<endl;
    // if(tt.search(1))cout<<"yes"<<endl;
    // else cout<<"no"<<endl;
    // if(tt.remove(5))cout<<"yes"<<endl;
    // else cout<<"no"<<endl;
    // tt.inorder();cout<<endl;
    // tt.postorder();cout<<endl;
    // tt.preorder();cout<<endl;
