...
int n,cnt_cmp,cnt_swp,cnt_out=0;//compare, swap, cout which order of the three test
...
void show_cnt()
{
    ...
    else if(cnt_out++%3==1)cout<<"reverse order:\n";
    else if(cnt_out++%3==2)cout<<"random order:\n";
    cout<<"compare count:"<<cnt_cmp<<" move count:"<<cnt_swp<<endl;
