...
public abstract class Operator implements DbIterator {
    ...
    /**
     * Opens the iterator so it will be ready to use. If overridden by a subclass, they should call
     * super.open() in order for Operator's internal state to be consistent. 
     */
     ...
     * and children[1] should be used. This method should simply replace whatever
     * the current children are.
     * 
     * 
     * @param children
    ...
    /**
     * @param card
     *            The estimated cardinality of this operator. Not necessary for labs 1-4
     *            
     * */
    protected void setEstimatedCardinality(long card) {
